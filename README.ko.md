...
OpenCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [hanbees.com/download](https://hanbees.com/download) 를 이용하세요.
...
OpenCode 설정에 대한 자세한 내용은 [**문서**](https://hanbees.com/docs) 를 참고하세요.
