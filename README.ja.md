...
OpenCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/opencode/releases) から直接ダウンロードするか、[hanbees.com/download](https://hanbees.com/download) を利用してください。
...
OpenCode の設定については [**ドキュメント**](https://hanbees.com/docs) を参照してください。
