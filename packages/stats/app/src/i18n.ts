...
const en = {
  ...
  "app.description":
    "Explore HanuBees.Ai usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  ...
  "home.topModelsDescription": "Usage of models across HanuBees.Ai.",
  ...
  "home.uniqueUsersDescription": "Daily unique HanuBees.Ai users by model.",
  ...
  "lab.description":
    "Compare {{lab}} models used in HanuBees.Ai, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  ...
  "model.description":
    "View {{model}} HanuBees.Ai usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. HanuBees.Ai usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's HanuBees.Ai usage",
  "model.ranked": "Ranked #{{rank}} across last week's HanuBees.Ai usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No HanuBees.Ai usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent HanuBees.Ai tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no HanuBees.Ai usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily HanuBees.Ai token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique HanuBees.Ai users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average HanuBees.Ai session shape.",
  ...
  "model.geoDescription": "HanuBees.Ai model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No HanuBees.Ai geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent HanuBees.Ai token volume.",
