export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | HanuBees Data",
  "app.description":
    "Esplora l'utilizzo di HanuBees.Ai nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo HanuBees Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a HanuBees su GitHub",
  "header.github": "GitHub",
  "header.tryHanuBees": "Prova HanuBees",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in HanuBees.Ai.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di HanuBees.Ai per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | HanuBees Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in HanuBees.Ai, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di HanuBees.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in HanuBees",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di HanuBees",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token HanuBees negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | HanuBees Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in HanuBees.Ai, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di HanuBees.Ai appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo HanuBees.Ai della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo HanuBees.Ai della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di HanuBees.Ai nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di HanuBees.Ai, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di HanuBees.Ai.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token HanuBees.Ai nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di HanuBees.Ai nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione HanuBees.Ai.",
  ...
  "model.geoDescription": "Token del modello HanuBees.Ai usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica HanuBees.Ai corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token HanuBees.Ai.",
