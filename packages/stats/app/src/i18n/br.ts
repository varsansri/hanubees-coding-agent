export const dict = {
  "app.title": "Ranking de uso de modelos de IA | HanuBees Data",
  "app.description":
    "Explore o uso do HanuBees.Ai em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do HanuBees Data sobre um fundo escuro padronizado",
  ...
  "footer.homeAria": "Início do HanuBees",
  ...
  "modal.title": "Newsletter do HanuBees",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no HanuBees.Ai.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do HanuBees.Ai por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | HanuBees Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no HanuBees.Ai, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do HanuBees.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no HanuBees",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do HanuBees",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do HanuBees nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | HanuBees Data",
  "model.description":
    "Veja dados de uso de {{model}} no HanuBees.Ai, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no HanuBees.Ai aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do HanuBees.Ai da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do HanuBees.Ai da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do HanuBees.Ai na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do HanuBees.Ai, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do HanuBees.Ai.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do HanuBees.Ai na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do HanuBees.Ai na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do HanuBees.Ai.",
  ...
  "model.geoDescription": "Tokens do modelo HanuBees.Ai usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do HanuBees.Ai correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do HanuBees.Ai.",
