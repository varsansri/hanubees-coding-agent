export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | HanuBees Data",
  "app.description":
    "Explora el uso de HanuBees.Ai en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de HanuBees Data sobre un fondo oscuro con patrón",
  ...
  "header.tryHanuBees": "Probar HanuBees",
  ...
  "footer.homeAria": "Inicio de HanuBees",
  ...
  "modal.title": "Boletín de HanuBees",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en HanuBees.Ai.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de HanuBees.Ai por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | HanuBees Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en HanuBees.Ai, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de HanuBees.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en HanuBees",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de HanuBees",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de HanuBees durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | HanuBees Data",
  "model.description":
    "Consulta datos de uso de {{model}} en HanuBees.Ai, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de HanuBees.Ai aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de HanuBees.Ai de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de HanuBees.Ai de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de HanuBees.Ai en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de HanuBees.Ai, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de HanuBees.Ai.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de HanuBees.Ai durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de HanuBees.Ai durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de HanuBees.Ai.",
  ...
  "model.geoDescription": "Tokens del modelo de HanuBees.Ai usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de HanuBees.Ai coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de HanuBees.Ai.",
