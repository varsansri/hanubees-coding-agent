export const dict = {
  "app.title": "Rankingi użycia modeli AI | HanuBees Data",
  "app.description":
    "Przeglądaj użycie HanuBees.Ai w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny HanuBees Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę HanuBees na GitHub",
  "header.github": "GitHub",
  "header.tryHanuBees": "Wypróbuj HanuBees",
  ...
  "footer.homeAria": "Strona główna HanuBees",
  ...
  "home.topModelsDescription": "Użycie modeli w HanuBees.Ai.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy HanuBees.Ai według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | HanuBees Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w HanuBees.Ai, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia HanuBees.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w HanuBees",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia HanuBees",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów HanuBees z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | HanuBees Data",
  "model.description":
    "Zobacz dane użycia {{model}} w HanuBees.Ai, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie HanuBees.Ai pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu HanuBees.Ai z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu HanuBees.Ai z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia HanuBees.Ai w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny HanuBees.Ai, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia HanuBees.Ai.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów HanuBees.Ai w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy HanuBees.Ai w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji HanuBees.Ai.",
  ...
  "model.geoDescription": "Tokeny modelu HanuBees.Ai użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne HanuBees.Ai nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów HanuBees.Ai.",
