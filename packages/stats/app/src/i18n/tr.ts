export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | HanuBees Data",
  "app.description":
    "HanuBees.Ai kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde HanuBees Data logosu",
  ...
  "footer.homeAria": "HanuBees ana sayfası",
  ...
  "home.topModelsDescription": "HanuBees.Ai genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz HanuBees.Ai kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | HanuBees Data",
  "lab.description":
    "HanuBees.Ai'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son HanuBees kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "HanuBees'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son HanuBees kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük HanuBees token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | HanuBees Data",
  "model.description":
    "{{model}} için HanuBees.Ai kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda HanuBees.Ai kullanımı görünür.",
  "model.unranked": "Geçen haftaki HanuBees.Ai kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki HanuBees.Ai kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde HanuBees.Ai kullanımı yok.",
  ...
  "model.overviewDescription": "Son HanuBees.Ai tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz HanuBees.Ai kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük HanuBees.Ai token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz HanuBees.Ai kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama HanuBees.Ai oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan HanuBees.Ai model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen HanuBees.Ai coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son HanuBees.Ai token hacmine göre yakındaki modeller.",
