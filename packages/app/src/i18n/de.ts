...
export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.HanuBees.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.HanuBeesGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HanuBees zu nutzen.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in HanuBees zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HanuBees zu nutzen.",
  ...
  "dialog.plugins.empty": "In HanuBees.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den hanubees-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von HanuBees ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem hanubees-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (HanuBees.json) auf Anbieter-/Modellnamen",
  ...
  "sidebar.gettingStarted.line1": "HanuBees enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "hanubees-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für HanuBees ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie HanuBees auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob HanuBees dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von HanuBees anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von HanuBees automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von HanuBees.",
