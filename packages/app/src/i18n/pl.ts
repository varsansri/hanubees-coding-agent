export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.HanuBees.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.HanuBeesGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w HanuBees.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Odwiedź ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w HanuBees.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w HanuBees.json",
  ...
  "dialog.server.description": "Przełącz serwer HanuBees, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja HanuBees ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu HanuBees",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (HanuBees.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "HanuBees zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla HanuBees",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd HanuBees na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy HanuBees ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw HanuBees.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania HanuBees",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji HanuBees.",
