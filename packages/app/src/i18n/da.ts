export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.HanuBees.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.HanuBeesGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i HanuBees.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.HanuBeesZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.HanuBeesZen.visit.prefix": "Besøg ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i HanuBees.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i HanuBees.json",
  ...
  "dialog.server.description": "Skift hvilken hanubees-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af HanuBees ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til hanubees-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (HanuBees.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, HanuBees understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "HanuBees inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør hanubees-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for HanuBees",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan HanuBees ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om HanuBees følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan HanuBees er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når HanuBees starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af HanuBees.",
