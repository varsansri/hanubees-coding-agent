...
export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.HanuBees.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.HanuBeesGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "HanuBees tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve HanuBees'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve HanuBees'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak HanuBees'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler HanuBees.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi HanuBees sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "HanuBees'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı HanuBees ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (HanuBees.json) sağlayıcı/model adlarını kontrol edin",
  ...
  "sidebar.gettingStarted.line1": "HanuBees ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "HanuBees Masaüstü",
  ...
  "settings.desktop.wsl.description": "HanuBees sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "HanuBees'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "HanuBees'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "HanuBees'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "HanuBees'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "HanuBees başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "HanuBees'un en son sürümünü kullanıyorsunuz.",
