export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.HanuBees.tagline": "Modèles optimisés et fiables",
  "dialog.provider.HanuBeesGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans HanuBees.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Visitez ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans HanuBees.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans HanuBees.json",
  ...
  "dialog.server.description": "Changez le serveur HanuBees auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'HanuBees ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe HanuBees",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (HanuBees.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'HanuBees ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "HanuBees inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur HanuBees dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour HanuBees",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'HanuBees sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si HanuBees suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'HanuBees.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'HanuBees",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'HanuBees.",
