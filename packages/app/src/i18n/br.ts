export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.HanuBees.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.HanuBeesGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no HanuBees.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Visite ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no HanuBees.",
  ...
  "dialog.plugins.empty": "Plugins configurados em HanuBees.json",
  ...
  "dialog.server.description": "Trocar para qual servidor HanuBees este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do HanuBees ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do HanuBees",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (HanuBees.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: HanuBees ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "HanuBees inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor HanuBees dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do HanuBees",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o HanuBees aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o HanuBees segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o HanuBees é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o HanuBees iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do HanuBees.",
