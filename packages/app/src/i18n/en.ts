export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.HanuBees.tagline": "Reliable optimized models",
  "dialog.provider.HanuBeesGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HanuBees.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.HanuBeesZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.HanuBeesZen.visit.prefix": "Visit ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HanuBees.",
  ...
  "dialog.plugins.empty": "Plugins configured in HanuBees.json",
  ...
  "dialog.server.description": "Switch which HanuBees server this app connects to.",
  ...
  "wsl.onboarding.step.HanuBees": "HanuBees",
  ...
  "wsl.onboarding.checkingHanuBees": "Checking HanuBees...",
  "wsl.onboarding.checkingHanuBeesIn": "Checking HanuBees in {{distro}}...",
  "wsl.onboarding.updatingHanuBees": "Updating HanuBees...",
  "wsl.onboarding.updatingHanuBeesIn": "Updating HanuBees in {{distro}}...",
  "wsl.onboarding.updateHanuBeesIn": "Update HanuBees in {{distro}}.",
  "wsl.onboarding.updateHanuBees": "Update HanuBees",
  "wsl.onboarding.HanuBeesReadyIn": "HanuBees is ready in {{distro}}.",
  "wsl.onboarding.HanuBeesReady": "HanuBees is ready.",
  "wsl.onboarding.installHanuBeesIn": "Install HanuBees in {{distro}}.",
  "wsl.onboarding.installHanuBees": "Install HanuBees",
  ...
  "wsl.onboarding.distroStatus.HanuBeesMissing": "HanuBees not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before HanuBees can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "HanuBees could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen HanuBees.",
  ...
  "toast.update.description": "A new version of HanuBees ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the HanuBees team",
  ...
  "error.chain.checkConfig": "Check your config (HanuBees.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HanuBees does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HanuBees includes free models so you can start immediately.",
  ...
  "app.name.desktop": "HanuBees Desktop",
  ...
  "settings.desktop.wsl.description": "Run the HanuBees server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for HanuBees",
  ...
  "settings.general.row.appearance.description": "Customise how HanuBees looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether HanuBees follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HanuBees is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HanuBees launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HanuBees.",
