...
export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.HanuBees.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.HanuBeesGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i HanuBees.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Besøk ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HanuBees.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HanuBees.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i HanuBees.json",
  ...
  "dialog.server.description": "Bytt hvilken hanubees-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HanuBees ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til hanubees-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (HanuBees.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HanuBees ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HanuBees inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør hanubees-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HanuBees",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HanuBees ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om HanuBees skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan HanuBees er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HanuBees starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HanuBees.",
