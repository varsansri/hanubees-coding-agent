export const dict = {
  ...
  "dialog.provider.HanuBees.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.HanuBees.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.HanuBeesGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje HanuBees",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u hanubees-u.",
  ...
  "provider.connect.HanuBeesZen.line1":
    "HanuBees Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.HanuBeesZen.visit.prefix": "Posjeti ",
  "provider.connect.HanuBeesZen.visit.link": "hanbees.com/zen",
  "provider.connect.HanuBeesZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u hanubees-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u hanubees-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u HanuBees.json",
  ...
  "dialog.server.description": "Promijeni na koji se HanuBees server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija hanubees-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku HanuBees timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (HanuBees.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: HanuBees još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HanuBees uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni HanuBees server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u hanubees-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako HanuBees izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li HanuBees prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu hanubees-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se HanuBees pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju hanubees-a.",
