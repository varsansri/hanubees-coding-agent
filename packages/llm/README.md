...
Schema-first LLM core for HanuBees. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@HanuBees-ai/llm"
import { OpenAI } from "@HanuBees-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@HanuBees-ai/llm/providers"
