export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do HanuBees",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do HanuBees foi baixada. Você gostaria de instalá-la e reiniciar?",
