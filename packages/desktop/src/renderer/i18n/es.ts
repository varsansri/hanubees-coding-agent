export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de HanuBees",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de HanuBees. ¿Quieres instalarla y reiniciar?",
