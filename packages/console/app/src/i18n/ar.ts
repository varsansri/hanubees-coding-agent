...
export const dict = {
  ...
  "notFound.title": "غير موجود | HanuBees",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار HanuBees الفاتح",
  "notFound.logoDarkAlt": "شعار HanuBees الداكن",
  ...
  "app.meta.description": "HanuBees - وكيل البرمجة مفتوح المصدر.",

  "home.title": "HanuBees | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",

  "temp.title": "HanuBees | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من HanuBees",
  "temp.feature.models.beforeLink": "يدعم أكثر من 75 مزود LLM من خلال",
  "temp.feature.models.afterLink": "، بما في ذلك النماذج المحلية",
  "temp.screenshot.caption": "واجهة HanuBees الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة HanuBees الطرفية بسمة tokyonight",
  "temp.logoLightAlt": "شعار HanuBees الفاتح",
  "temp.logoDarkAlt": "شعار HanuBees الداكن",
  ...
  "home.what.title": "ما هو HanuBees؟",
  "home.what.body": "HanuBees وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم HanuBees ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن HanuBees أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو HanuBees؟",
  "home.faq.a1":
    "HanuBees وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم HanuBees؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام HanuBees؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ HanuBees يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن HanuBees يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع HanuBees؟",
  "home.faq.a4.p1":
    "نعم، يدعم HanuBees خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام HanuBees في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! HanuBees متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة HanuBees؟",
  "home.faq.a6":
    "HanuBees مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل HanuBees مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، HanuBees مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها HanuBees وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  "home.zenCta.link": "تعرف على Zen",

  "zen.title": "HanuBees Zen | مجموعة منسقة من النماذج المحسنة والموثوقة لوكلاء البرمجة",
  "zen.hero.title": "نماذج محسنة وموثوقة لوكلاء البرمجة",
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها HanuBees وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو HanuBees Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ HanuBees.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن HanuBees من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف HanuBees فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع HanuBees، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي HanuBees.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع HanuBees، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "go.title": "HanuBees.Ai | نماذج برمجة منخفضة التكلفة للجميع",
  "go.meta.description":
  ...
  "go.graph.free": "مجاني",
  "go.graph.freePill": "HanuBees.Ai ونماذج مجانية",
  "go.graph.go": "Go",
  ...
  "go.problem.body":
    "نحن نركز على تقديم تجربة HanuBees لأكبر عدد ممكن من الناس. HanuBees.Ai هو اشتراك منخفض التكلفة: $5 للشهر الأول، ثم $10/شهر. يوفر حدودا سخية ووصولا موثوقا إلى نماذج المصدر المفتوح الأكثر قدرة.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "يبدأ Go من $5 للشهر الأول، ثم $10/شهر. يمكنك استخدامه مع HanuBees أو أي وكيل.",
  ...
  "go.faq.a9":
    "تشمل النماذج المجانية HanuBees.Ai بالإضافة إلى النماذج الترويجية المتاحة في ذلك الوقت، مع حصة 200 طلب/يوم. يتضمن Go نماذج GLM-5.2 وGLM-5.1 وKimi K2.7 Code وKimi K2.6 وMiMo-V2.5-Pro وMiMo-V2.5 وQwen3.7 Max وQwen3.7 Plus وQwen3.6 Plus وMiniMax M2.7 وMiniMax M3 وDeepSeek V4 Pro وDeepSeek V4 Flash مع حصص طلبات أعلى مطبقة عبر نوافذ متجددة (5 ساعات، أسبوعيًا، وشهريًا)، تعادل تقريبًا 12 دولارًا كل 5 ساعات، و30 دولارًا في الأسبوع، و60 دولارًا في الشهر (تختلف أعداد الطلبات الفعلية حسب النموذج والاستخدام).",
  ...
  "zen.api.error.trialEnded":
    "انتهى العرض المجاني لـ {{model}}. يمكنك مواصلة استخدام النموذج بالاشتراك في HanuBees.Ai - {{link}}",

  "black.meta.title": "HanuBees Black | الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.meta.description": "احصل على وصول إلى Claude، GPT، Gemini والمزيد مع خطط اشتراك HanuBees Black.",
  "black.hero.title": "الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.hero.subtitle": "بما في ذلك Claude، GPT، Gemini والمزيد",
  "black.title": "HanuBees Black | الأسعار",
  ...
  "black.workspace.title": "HanuBees Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في HanuBees Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار HanuBees Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع HanuBees وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر HanuBees",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ HanuBees ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات HanuBees.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة HanuBees",
  ...
  "workspace.black.subscription.message": "أنت مشترك في HanuBees Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة HanuBees Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة HanuBees Black بقيمة ${{plan}} شهريًا.",
  ...
  "workspace.lite.subscription.message": "أنت مشترك في HanuBees.Ai.",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "HanuBees.Ai" كمزود في إعدادات opencode الخاصة بك لاستخدام نماذج Go.',
  ...
  "workspace.lite.black.message":
    "أنت مشترك حاليًا في HanuBees Black أو في قائمة الانتظار. يرجى إلغاء الاشتراك أولاً إذا كنت ترغب في التبديل إلى Go.",
  "workspace.lite.other.message":
    "عضو آخر في مساحة العمل هذه مشترك بالفعل في HanuBees.Ai. يمكن لعضو واحد فقط لكل مساحة عمل الاشتراك.",
  "workspace.lite.promo.description":
    "يبدأ HanuBees.Ai بسعر {{price}}، ثم $10/شهر، ويوفر وصولا موثوقا لنماذج البرمجة المفتوحة الشهيرة مع حدود استخدام سخية.",
  ...
  "download.title": "HanuBees | تنزيل",
  "download.meta.description": "نزّل HanuBees لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل HanuBees",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "HanuBees للطرفية",
  "download.section.desktop": "HanuBees لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات HanuBees",
  "download.section.integrations": "تكاملات HanuBees",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط HanuBees بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن HanuBees يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "HanuBees مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل HanuBees مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في HanuBees.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "HanuBees | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع HanuBees لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل HanuBees بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو HanuBees Enterprise؟",
  "enterprise.faq.a1":
    "HanuBees Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع HanuBees Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم HanuBees بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع HanuBees Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم HanuBees بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "HanuBees | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ HanuBees",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ HanuBees.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "HanuBees | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ HanuBees",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ HanuBees",
