...
export const dict = {
  ...en,
  "app.meta.description": "HanuBees - L'agent de code open source.",
  "nav.github": "GitHub",
  ...
  "notFound.title": "Introuvable | HanuBees",
  "notFound.heading": "404 - Page introuvable",
  "notFound.home": "Accueil",
  "notFound.docs": "Documentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "HanuBees logo light",
  "notFound.logoDarkAlt": "HanuBees logo dark",
  ...
  "home.title": "HanuBees | L'agent de code IA open source",

  "temp.title": "HanuBees | Agent de code IA conçu pour le terminal",
  ...
  "temp.feature.zen.afterLink": "fournie par HanuBees",
  ...
  "temp.screenshot.caption": "HanuBees TUI avec le thème tokyonight",
  "temp.screenshot.alt": "HanuBees TUI avec le thème tokyonight",
  "temp.logoLightAlt": "HanuBees logo light",
  "temp.logoDarkAlt": "HanuBees logo dark",
  ...
  "home.what.title": "Qu'est-ce que HanuBees ?",
  "home.what.body":
    "HanuBees est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, HanuBees est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "HanuBees ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que HanuBees ?",
  "home.faq.a1":
    "HanuBees est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser HanuBees ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser HanuBees ?",
  "home.faq.a3.p1":
    "Pas forcément : HanuBees propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais HanuBees fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec HanuBees ?",
  "home.faq.a4.p1":
    "Oui, HanuBees prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser HanuBees uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! HanuBees est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte HanuBees ?",
  "home.faq.a6":
    "HanuBees est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "HanuBees est-il open source ?",
  "home.faq.a8.p1": "Oui, HanuBees est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que HanuBees a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "HanuBees Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que HanuBees a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que HanuBees Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière HanuBees.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus HanuBees peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, HanuBees ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec HanuBees, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de HanuBees.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec HanuBees, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "go.title": "HanuBees.Ai | Modèles de code à faible coût pour tous",
  "go.meta.description":
  ...
  "go.graph.freePill": "HanuBees.Ai et modèles gratuits",
  "go.graph.go": "Go",
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience HanuBees au plus grand nombre. HanuBees.Ai est un abonnement à faible coût : $5 pour le premier mois, puis 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go commence à $5 pour le premier mois, puis 10 $/mois. Vous pouvez l'utiliser avec HanuBees ou n'importe quel agent.",
  ...
  "go.faq.q1": "Qu'est-ce que HanuBees.Ai ?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promotion gratuite de {{model}} est terminée. Vous pouvez continuer à utiliser le modèle en vous abonnant à HanuBees.Ai - {{link}}",

  "black.meta.title": "HanuBees Black | Accédez aux meilleurs modèles de code au monde",
  "black.meta.description": "Accédez à Claude, GPT, Gemini et plus avec les forfaits d'abonnement HanuBees Black.",
  "black.hero.title": "Accédez aux meilleurs modèles de code au monde",
  "black.hero.subtitle": "Y compris Claude, GPT, Gemini et plus",
  "black.title": "HanuBees Black | Tarification",
  ...
  "black.workspace.title": "HanuBees Black | Sélectionner un espace de travail",
  "black.workspace.selectPlan": "Sélectionnez un espace de travail pour ce forfait",
  "black.workspace.name": "Espace de travail {{n}}",
  "black.subscribe.title": "S'abonner à HanuBees Black",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente HanuBees Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec HanuBees quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez HanuBees",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez HanuBees et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services HanuBees.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API HanuBees Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à HanuBees Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait HanuBees Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait HanuBees Black à {{plan}} $ par mois.",
  ...
  "workspace.lite.subscription.message": "Vous êtes abonné à HanuBees.Ai.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Sélectionnez "HanuBees.Ai" comme fournisseur dans votre configuration opencode pour utiliser les modèles Go.',
  ...
  "workspace.lite.black.message":
    "Vous êtes actuellement abonné à HanuBees Black ou sur liste d'attente. Veuillez d'abord vous désabonner si vous souhaitez passer à Go.",
  "workspace.lite.other.message":
    "Un autre membre de cet espace de travail est déjà abonné à HanuBees.Ai. Un seul membre par espace de travail peut s'abonner.",
  "workspace.lite.promo.description":
    "HanuBees.Ai commence à {{price}}, puis 10 $/mois, et offre un accès fiable aux modèles de code ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.title": "HanuBees | Téléchargement",
  "download.meta.description": "Téléchargez HanuBees pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger HanuBees",
  ...
  "download.section.desktop": "HanuBees Desktop (Bêta)",
  "download.section.extensions": "Extensions HanuBees",
  "download.section.integrations": "Intégrations HanuBees",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter HanuBees à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", HanuBees fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "HanuBees est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si HanuBees fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans HanuBees.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "HanuBees | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez HanuBees pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "HanuBees fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que HanuBees Enterprise ?",
  "enterprise.faq.a1":
    "HanuBees Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec HanuBees Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, HanuBees ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec HanuBees Enterprise ?",
  "enterprise.faq.a4":
    "Oui. HanuBees ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "HanuBees | Marque",
  "brand.meta.description": "Guide de marque HanuBees",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque HanuBees.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "HanuBees | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'HanuBees",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour HanuBees",
