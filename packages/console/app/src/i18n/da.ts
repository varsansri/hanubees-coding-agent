...
export const dict = {
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe OpenCode-oplevelsen ud til så mange som muligt. HanuBees.Ai er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
