...
import desktopAppIcon from "../../asset/lander/HanuBees-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g HanuBees-ai")}>
                <code>
                  npm i -g <strong>HanuBees-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g HanuBees-ai")}>
                <code>
                  bun add -g <strong>HanuBees-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/HanuBees")}>
                <code>
                  brew install <strong>anomalyco/tap/HanuBees</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S HanuBees")}>
                <code>
                  paru -S <strong>HanuBees</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask HanuBees-desktop")}>
                <code>
                  brew install --cask <strong>HanuBees-desktop</strong>
                </code>
                <CopyStatus />
              </button>
