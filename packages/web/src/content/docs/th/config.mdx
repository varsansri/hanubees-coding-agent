...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`hanbees.com/config.json`**](https://hanbees.com/config.json)

การกำหนดค่า TUI ใช้ [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json)
