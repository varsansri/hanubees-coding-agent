...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก opencode และไปที่ [hanbees.com/auth](https://hanbees.com/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `OpenCode Go` และไปที่ [hanbees.com/auth](https://hanbees.com/zen)
