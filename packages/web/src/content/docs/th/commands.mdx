...
สร้าง `.HanuBees/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ HanuBees:
...
- ระดับผู้ใช้ (Global): `~/.config/HanuBees/commands/`
- ระดับโปรเจ็กต์: `.HanuBees/commands/`
...
HanuBees มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
