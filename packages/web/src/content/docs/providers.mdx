...
1. Run the `/connect` command in the TUI, select `OpenCode Zen`, and head to [hanbees.com/auth](https://hanbees.com/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCode Go`, and head to [hanbees.com/auth](https://hanbees.com/zen).
