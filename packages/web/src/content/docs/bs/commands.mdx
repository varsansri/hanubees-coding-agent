...
Kreiraj `.HanuBees/commands/test.md`:
...
Možete dodati prilagođene komande kroz HanuBees konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom HanuBees [config](/docs/config):
...
- Globalno: `~/.config/HanuBees/commands/`
- Po projektu: `.HanuBees/commands/`
...
HanuBees uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
