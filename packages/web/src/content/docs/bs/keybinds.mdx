...
HanuBees ima listu veza tipki koje možete prilagoditi putem `tui.json`.
...
HanuBees koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije HanuBees za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `HanuBees.json`.
