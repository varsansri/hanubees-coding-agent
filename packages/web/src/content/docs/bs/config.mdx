...
Konfiguracijski fajl ima šemu koja je definirana u [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

TUI konfiguracija koristi [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
