---
title: LSP serveri
description: HanuBees se integriše sa vašim LSP serverima.
---

HanuBees se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

HanuBees dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `HanuBees_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i HanuBees otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj HanuBees konfiguraciji.
