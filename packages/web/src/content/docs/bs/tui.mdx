---
title: TUI
description: Korištenje korisničkog interfejsa HanuBees terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HanuBees pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje HanuBees pokreće TUI za trenutni direktorij.
...
Kada koristite HanuBees TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u HanuBees. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz HanuBees. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `HanuBees.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo HanuBees čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `HanuBees.default`.
