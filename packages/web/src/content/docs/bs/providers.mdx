...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [hanbees.com/auth](https://hanbees.com/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `OpenCode Go` i idite na [hanbees.com/auth](https://hanbees.com/zen).
