...
1. Kør kommandoen `/connect` i TUI, vælg opencode og gå til [hanbees.com/auth](https://hanbees.com/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `OpenCode Go`, og gå til [hanbees.com/auth](https://hanbees.com/zen).
