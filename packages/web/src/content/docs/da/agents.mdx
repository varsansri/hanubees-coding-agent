...
Der er to typer agenter i HanuBees; primære agenter og subagenter.
...
HanuBees leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
HanuBees leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

HanuBees leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i HanuBees's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
Konfigurer agent i din `HanuBees.json`-konfigurationsfil:
...
- Globalt: `~/.config/HanuBees/agents/`
- Pr. projekt: `.HanuBees/agents/`
...
Hvis ingen temperatur er angivet, bruger HanuBees modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale HanuBees-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din HanuBees-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [HanuBees Zen](/docs/zen), vil du bruge `HanuBees/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `HanuBees models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/varsansri/hanubees-coding-agent).
:::
