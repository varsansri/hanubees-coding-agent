---
title: LSP-servere
description: HanuBees integreres med dine LSP-servere.
---

HanuBees kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

HanuBees leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `HanuBees_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og HanuBees åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din HanuBees-konfiguration.
