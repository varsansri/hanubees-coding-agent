...
description: Opret værktøjer, som LLM kan kalde HanuBees ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med HanuBeess [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.HanuBees/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/HanuBees/tools/`.
