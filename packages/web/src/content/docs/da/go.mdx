...
HanuBees Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i HanuBees. Du abonnerer på HanuBees Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med HanuBees.
:::
...
HanuBees Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

HanuBees Go fungerer som enhver anden udbyder i HanuBees.

1. Du logger ind på **<a href={console}>HanuBees Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `HanuBees Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på HanuBees Go.
:::
...
HanuBees Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din HanuBees config
bruger formatet `HanuBees-go/<model-id>`. For eksempel for Kimi K2.7 Code, vil du
bruge `HanuBees-go/kimi-k2.7-code` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med HanuBees.
