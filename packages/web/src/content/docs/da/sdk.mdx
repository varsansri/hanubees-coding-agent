...
Brug den til at bygge integrasjoner og kontrollere HanuBees programmatisk.
...
Opret en forekomst av HanuBees:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `HanuBees.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av HanuBees, kan du oprete en klientforekomst for at koble til den:
