...
Her er alle de innebygde verktøyene som er tilgængelige i HanuBees.
...
:::note
Dette verktøyet er bare tilgængelig når `HanuBees_EXPERIMENTAL_LSP_TOOL=true` (eller `HanuBees_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger HanuBees-leverandøren eller når miljøvariabelen `HanuBees_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
