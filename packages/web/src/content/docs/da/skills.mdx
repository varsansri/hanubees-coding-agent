...
Agentferdigheter lar HanuBees oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går HanuBees opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
HanuBees viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `HanuBees.json`:
