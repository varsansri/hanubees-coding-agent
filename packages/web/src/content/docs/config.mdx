...
The server/runtime config schema is defined in [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

TUI config uses [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
