...
1. Run the `/connect` command in the TUI, select opencode, and head to [hanbees.com/auth](https://hanbees.com/auth).
...
Here's an [example conversation](https://hanbees.com/s/4XP1fce5) with OpenCode.
