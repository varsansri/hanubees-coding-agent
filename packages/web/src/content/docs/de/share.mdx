---
title: Teilen
description: Teile HanuBees-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu HanuBees-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht HanuBees Folgendes:
...
HanuBees hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt HanuBees den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`HanuBees.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du HanuBees in deiner Organisation einsetzt.
