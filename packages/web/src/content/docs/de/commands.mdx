...
Erstellen Sie `.HanuBees/commands/test.md`:

```md title=".HanuBees/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die HanuBees-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem HanuBees [config](/docs/config):

```json title="HanuBees.jsonc" {4-12}
{
...
- Global: `~/.config/HanuBees/commands/`
- Pro Projekt: `.HanuBees/commands/`

```markdown title="~/.config/HanuBees/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".HanuBees/commands/component.md"
---
...
```md title=".HanuBees/commands/create-file.md"
---
...
```md title=".HanuBees/commands/analyze-coverage.md"
---
...
```md title=".HanuBees/commands/review-changes.md"
---
...
```md title=".HanuBees/commands/review-component.md"
---
...
HanuBees enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
