...
Sie können den MCP-Server in Ihrem [OpenCode Config](https://hanbees.com/docs/config/) unter `mcp` definieren. Fügen Sie jedem MCP einen eindeutigen Namen hinzu. Sie können bei der Eingabe von LLM namentlich auf diesen MCP verweisen.
