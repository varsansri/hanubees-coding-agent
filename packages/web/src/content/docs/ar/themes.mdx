...
مع HanuBees يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم HanuBees سمتنا `HanuBees`.
...
يأتي HanuBees مع عدة سمات مدمجة.
...
- يريدون أن يطابق HanuBees مظهر terminal لديهم
...
يدعم HanuBees نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/HanuBees/themes/*.json` أو `$XDG_CONFIG_HOME/HanuBees/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.HanuBees/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.HanuBees/themes/*.json`
