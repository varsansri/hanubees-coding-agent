...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [hanbees.com/auth](https://hanbees.com/auth).
...
إليك [مثالا لمحادثة](https://hanbees.com/s/4XP1fce5) مع OpenCode.
