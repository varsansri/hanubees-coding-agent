---
title: TUI
description: استخدام واجهة المستخدم TUI في HanuBees.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر HanuBees واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل HanuBees إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة HanuBees في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى HanuBees. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من HanuBees. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `HanuBees.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار HanuBees بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `HanuBees.default`.
