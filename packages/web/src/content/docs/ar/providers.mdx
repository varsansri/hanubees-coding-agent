...
1. شغّل الأمر `/connect` في TUI، واختر opencode، ثم انتقل إلى [hanbees.com/auth](https://hanbees.com/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `OpenCode Go`، ثم انتقل إلى [hanbees.com/auth](https://hanbees.com/zen).
