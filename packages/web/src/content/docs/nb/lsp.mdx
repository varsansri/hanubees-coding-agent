---
title: LSP-servere
description: HanuBees integreres med LSP-serverne dine.
---

HanuBees kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

HanuBees kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `HanuBees_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og HanuBees åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i HanuBees-konfigurasjonen.
