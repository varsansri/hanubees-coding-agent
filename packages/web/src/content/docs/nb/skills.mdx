...
Agentferdigheter lar HanuBees oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
HanuBees søker etter disse stedene:

- Prosjektkonfigurasjon: `.HanuBees/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/HanuBees/skills/<name>/SKILL.md`
...
For prosjektlokale stier går HanuBees opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.HanuBees/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/HanuBees/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.HanuBees/skills/git-release/SKILL.md` slik:
...
HanuBees viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `HanuBees.json`:
...
**For innebygde agenter** (i `HanuBees.json`):
