---
title: SDK
description: Typesikker JS-klient for HanuBees-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

HanuBees JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere HanuBees programmatisk.
...
Opprett en forekomst av HanuBees:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `HanuBees.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av HanuBees, kan du opprette en klientforekomst for å koble til den:
