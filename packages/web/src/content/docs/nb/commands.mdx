...
Opprett `.HanuBees/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom HanuBees-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i HanuBees [config](/docs/config):
...
- Per prosjekt: `.HanuBees/commands/`
...
HanuBees inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
