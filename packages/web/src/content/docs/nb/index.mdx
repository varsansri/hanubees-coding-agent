...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [hanbees.com/auth](https://hanbees.com/auth).
...
Her er en [eksempelsamtale](https://hanbees.com/s/4XP1fce5) med OpenCode.
