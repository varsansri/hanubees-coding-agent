...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Zen` og gå til [hanbees.com/auth](https://hanbees.com/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `OpenCode Go`, og gå til [hanbees.com/auth](https://hanbees.com/zen).
