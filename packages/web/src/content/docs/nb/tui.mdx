---
title: TUI
description: Bruke HanuBees-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HanuBees gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre HanuBees starter TUI for gjeldende katalog.
...
Når du bruker HanuBees TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til HanuBees. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt HanuBees. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `HanuBees.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge HanuBees venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `HanuBees.default`.
