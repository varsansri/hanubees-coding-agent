...
Le fichier de configuration a un schéma défini dans [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

La configuration TUI utilise [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
