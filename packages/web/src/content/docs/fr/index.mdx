...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [hanbees.com/auth](https://hanbees.com/auth).
...
Voici un [exemple de conversation](https://hanbees.com/s/4XP1fce5) avec OpenCode.
