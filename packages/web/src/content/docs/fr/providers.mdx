...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et dirigez-vous vers [hanbees.com/auth](https://hanbees.com/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `OpenCode Go` et rendez-vous sur [hanbees.com/auth](https://hanbees.com/zen).
