...
`.HanuBees/commands/test.md` を作成します。
...
カスタムコマンドは、HanuBees 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

HanuBees [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/HanuBees/commands/`
- プロジェクトごと: `.HanuBees/commands/`
...
HanuBees には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
