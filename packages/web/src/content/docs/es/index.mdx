...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [hanbees.com/auth](https://hanbees.com/auth).
...
Aquí tiene una [conversación de ejemplo](https://hanbees.com/s/4XP1fce5) con OpenCode.
