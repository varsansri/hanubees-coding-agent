...
Crear `.HanuBees/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración HanuBees o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su HanuBees [config](/docs/config):
...
- Por proyecto: `.HanuBees/commands/`
...
HanuBees incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
