...
Con HanuBees puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, HanuBees usa nuestro propio tema `HanuBees`.
...
HanuBees viene con varios temas integrados.
...
- Quiere que HanuBees coincida con la apariencia de su terminal
...
HanuBees admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/HanuBees/themes/*.json` o `$XDG_CONFIG_HOME/HanuBees/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.HanuBees/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.HanuBees/themes/*.json`
