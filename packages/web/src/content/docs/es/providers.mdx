...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [hanbees.com/auth](https://hanbees.com/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `OpenCode Go` y diríjase a [hanbees.com/auth](https://hanbees.com/zen).
