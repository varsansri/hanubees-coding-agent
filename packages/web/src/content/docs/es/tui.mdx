---
title: TUI
description: Usando la interfaz de usuario del terminal HanuBees.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HanuBees proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar HanuBees se inicia TUI para el directorio actual.
...
Cuando utilice HanuBees TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a HanuBees. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de HanuBees. _Alias_: `/quit`, `/q`
...
Esto es independiente de `HanuBees.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera HanuBees después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `HanuBees.default`.
