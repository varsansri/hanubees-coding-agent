...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Zen` e acesse [hanbees.com/zen](https://hanbees.com/zen).
...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Go` e acesse [hanbees.com/zen](https://hanbees.com/zen).
