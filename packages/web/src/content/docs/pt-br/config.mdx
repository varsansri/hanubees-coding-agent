...
O esquema de configuração do servidor/tempo de execução é definido em [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

A configuração do TUI usa [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
