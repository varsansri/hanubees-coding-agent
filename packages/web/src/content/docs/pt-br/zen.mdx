---
title: Zen
description: Lista selecionada de modelos fornecidos pelo HanuBees.
---
...
O HanuBees Zen é uma lista de modelos testados e verificados fornecidos pela equipe do HanuBees.

O Zen funciona como qualquer outro provedor no HanuBees. Você faz login no HanuBees Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o HanuBees.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o HanuBees.
:::
...
O HanuBees Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O HanuBees Zen funciona como qualquer outro provedor no HanuBees.

1. Você faz login no **<a href={console}>HanuBees Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona HanuBees Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do HanuBees usa o formato `HanuBees/<model-id>`. Por exemplo, para GPT 5.5, você usaria `HanuBees/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no HanuBees por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no HanuBees por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no HanuBees por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no HanuBees por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no HanuBees por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o HanuBees também.
