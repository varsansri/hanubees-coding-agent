...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [hanbees.com/auth](https://hanbees.com/auth).
...
Aqui está uma [conversa de exemplo](https://hanbees.com/s/4XP1fce5) com o opencode.
