...
Utwórz `.HanuBees/commands/test.md`:
...
Możesz zdefiniować polecenia w `HanuBees.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji HanuBees:
...
- Globalnie: `~/.config/HanuBees/commands/`
- Na projekt: `.HanuBees/commands/`
...
HanuBees zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
