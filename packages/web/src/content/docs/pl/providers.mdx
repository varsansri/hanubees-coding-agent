...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Zen` i przejdź do [hanbees.com/auth](https://hanbees.com/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Go` i przejdź do [hanbees.com/auth](https://hanbees.com/zen).
