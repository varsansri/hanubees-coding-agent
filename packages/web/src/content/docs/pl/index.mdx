...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [hanbees.com/auth](https://hanbees.com/auth).
...
Oto [przykładowa rozmowa](https://hanbees.com/s/4XP1fce5) z opencode.
