...
Il file di configurazione ha uno schema definito in [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

La configurazione TUI usa [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
