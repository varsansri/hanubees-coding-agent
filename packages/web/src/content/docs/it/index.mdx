...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [hanbees.com/auth](https://hanbees.com/auth).
...
Ecco un'[esempio di conversazione](https://hanbees.com/s/4XP1fce5) con OpenCode.
