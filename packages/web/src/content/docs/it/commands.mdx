...
Crea `.HanuBees/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di HanuBees o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di HanuBees:
...
- Globale: `~/.config/HanuBees/commands/`
- Per progetto: `.HanuBees/commands/`
...
HanuBees include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
