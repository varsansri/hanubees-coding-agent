...
description: Crea strumenti che l'LLM puo chiamare in HanuBees.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di HanuBees come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.HanuBees/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/HanuBees/tools/`.
