...
`.HanuBees/commands/test.md` oluştur:
...
HanuBees işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

HanuBees [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/HanuBees/commands/`
- Proje başına: `.HanuBees/commands/`
...
HanuBees, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
