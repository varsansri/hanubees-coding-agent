...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını hanbees.com'de barındırmak için kullandığımız hizmete gönderilir.
