---
title: Paylasim
description: HanuBees konusmalarini genel baglantilarla paylasin.
---

HanuBees'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda HanuBees:
...
HanuBees, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak HanuBees manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `HanuBees.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda HanuBees kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
