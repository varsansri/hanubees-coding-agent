...
description: HanuBees, LSP sunucularınızla bütünleşir.
---

HanuBees, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

HanuBees, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`HanuBees_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP etkinleştirildiğinde ve HanuBees bir dosyayı açtığında:
...
LSP sunucularını, HanuBees yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
