...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [hanbees.com/auth](https://hanbees.com/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `OpenCode Go`'yu seçin ve [hanbees.com/auth](https://hanbees.com/zen) adresine gidin.
