---
title: Özel Araçlar
description: LLM'un HanuBees'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. HanuBees'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.HanuBees/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/HanuBees/tools/` içine yerleştirerek.
