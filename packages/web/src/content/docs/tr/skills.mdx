...
Ajan becerileri, HanuBees'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
HanuBees su konumlari tarar:

- Proje konfigurasyonu: `.HanuBees/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/HanuBees/skills/<name>/SKILL.md`
...
Proje yerel yollarinda HanuBees, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.HanuBees/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/HanuBees/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.HanuBees/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
HanuBees, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`HanuBees.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`HanuBees.json` icinde):
