---
title: Zen
description: HanuBees tarafından sağlanan seçilmiş modeller listesi.
---
...
HanuBees Zen, HanuBees ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, HanuBees'daki diğer sağlayıcılar gibi çalışır. HanuBees Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve HanuBees kullanmak için buna ihtiyacınız yoktur.
...
:::tip
HanuBees ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
HanuBees Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

HanuBees Zen, HanuBees'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>HanuBees Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, HanuBees Zen'i seçin ve API anahtarınızı yapıştırın.
...
HanuBees yapılandırmanızdaki [model id](/docs/config/#models) `HanuBees/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `HanuBees/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için HanuBees'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için HanuBees'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için HanuBees'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için HanuBees'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için HanuBees'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
HanuBees Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca HanuBees ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
