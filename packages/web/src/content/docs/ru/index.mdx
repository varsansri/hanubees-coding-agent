...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [hanbees.com/auth](https://hanbees.com/auth).
...
Вот [пример диалога](https://hanbees.com/s/4XP1fce5) с opencode.
