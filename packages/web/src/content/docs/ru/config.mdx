...
Файл конфигурации имеет схему, определенную в [**`hanbees.com/config.json`**](https://hanbees.com/config.json).

Конфигурация TUI использует [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json).
