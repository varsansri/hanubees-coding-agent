...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Zen` и перейдите по адресу [hanbees.com/auth](https://hanbees.com/zen).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Go` и перейдите по адресу [hanbees.com/auth](https://hanbees.com/zen).
