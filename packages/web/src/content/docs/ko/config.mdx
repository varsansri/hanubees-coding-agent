...
server/runtime config schema는 [**`hanbees.com/config.json`**](https://hanbees.com/config.json)에 정의되어 있습니다.

TUI config는 [**`hanbees.com/tui.json`**](https://hanbees.com/tui.json)을 사용합니다.
