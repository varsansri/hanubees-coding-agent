...
function useShareUrl() {
  return isMock() ? "https://dev.hanbees.com" : "https://hanbees.com"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.hanbees.com/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.hanbees.com/exchange_github_app_token", {
      method: "POST",
      headers: {
