...
npm i -g hanubees@latest        # o bun/pnpm/yarn
```
...
HanuBees también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/varsansri/hanubees-coding-agent/releases) o desde [hanbees.com/download](https://hanbees.com/download).
...
1. `$HANUBEES_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.hanubees/bin` - Alternativa por defecto
...
HanuBees incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://hanbees.com/docs/agents).

### Documentación

Para más información sobre cómo configurar HanuBees, [**ve a nuestra documentación**](https://hanbees.com/docs).

### Contribuir

Si te interesa contribuir a HanuBees, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en HanuBees

Si estás trabajando en un proyecto basado en HanuBees y usas "HanuBees" como parte del nombre, por ejemplo, "hanubees-dashboard" u "hanubees-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de HanuBees y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/hanubees) | [X.com](https://x.com/hanubees)
