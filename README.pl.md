...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/opencode/releases) lub z [hanbees.com/download](https://hanbees.com/download).
...
Więcej informacji o konfiguracji OpenCode znajdziesz w [**dokumentacji**](https://hanbees.com/docs).
