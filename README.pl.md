...
# Menedżery pakietów
npm i -g hanubees@latest        # albo bun/pnpm/yarn
```
...
HanuBees jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/varsansri/hanubees-coding-agent/releases) lub z [hanbees.com/download](https://hanbees.com/download).
...
1. `$HANUBEES_INSTALL_DIR` - Własny katalog instalacji
2. `$XDG_BIN_DIR` - Ścieżka zgodna ze specyfikacją XDG Base Directory
3. `$HOME/bin` - Standardowy katalog binarny użytkownika (jeśli istnieje lub można go utworzyć)
4. `$HOME/.hanubees/bin` - Domyślny fallback
...
HanuBees zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Dowiedz się więcej o [agents](https://hanbees.com/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji HanuBees znajdziesz w [**dokumentacji**](https://hanbees.com/docs).

### Współtworzenie

Jeśli chcesz współtworzyć HanuBees, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.

### Budowanie na HanuBees

Jeśli pracujesz nad projektem związanym z HanuBees i używasz "HanuBees" jako części nazwy (na przykład "hanubees-dashboard" lub "hanubees-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół HanuBees i nie jest z nami w żaden sposób powiązany.

---

**Dołącz do naszej społeczności** [Discord](https://discord.gg/hanubees) | [X.com](https://x.com/hanubees)
